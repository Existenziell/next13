  ...
  return (
    <div>
      {darkmode === 'light' ?
        ...
        :
        <svg onClick={setLight} xmlns='http://www.w3.org/2000/svg' className='h-8 w-8 md:h-6 md:w-6 cursor-pointer text-brand hover:text-cta transition-colors' fill='none' viewBox='0 0 24 24' stroke='currentColor'>
